    ...
    <div id="app">
        ...
        <main class="py-4">
            <div class="row">
                @if(Auth::check())
                <div class="col-sm-3">
                    <ul style="float:left" class="menu-siderbar nav flex-column">
                        <li class="nav-item">
                            <a href="{{url("home")}}" class="nav-link"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url("manageidentity")}}" class="nav-link"><i class="fa fa-address-book" aria-hidden="true"></i> Manage Identity</a>
                        </li>
